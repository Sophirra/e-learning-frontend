...
/**
 * The root select component that manages the overall select state and behavior.
 * @param props - Props to pass to the root select element
 */
function Select({
  ...props
...
/**
 * Groups related select items together for better organization.
 * @param props - Props to pass to the select group element
 */
 ...
 * @param props - Props to pass to the select value element
 */
 ...
 * @param props - Additional props to pass to the trigger element
 */
  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <icons.ChevronDownIcon className="size-4 opacity-50" />
 ...
 * @param className - Additional CSS classes to apply
 * @param children - Content to render inside the dropdown
 * @param position - Position strategy for the dropdown ("popper" by default)
 ...
 * @param className - Additional CSS classes to apply
 * @param props - Additional props to pass to the label element
 */
 ...
 * @param props - Additional props to pass to the item element
 */
function SelectItem({
  className,
  children,
 ...
 * @param className - Additional CSS classes to apply
 * @param props - Additional props to pass to the scroll button element
 */
...
/**
 * Button for scrolling down through select options when they overflow.
 * @param className - Additional CSS classes to apply
 * @param props - Additional props to pass to the scroll button element
 */
