...
import {ChevronLeft, ChevronRight, Circle, CircleCheckBig as Check,} from "lucide-react";
...
export function SolveQuizPage() {
    ...
    const handleAnswerSelect = (answerId: string) => {
        ...
        if (quiz.isMultipleChoice) {
            ...
            currentQuestion.answers[answerIndex].isSelected = !currentQuestion.answers[answerIndex].isSelected;
        } else {
            // Dla single choice odznaczamy wszystkie inne odpowiedzi
            const isCurrentlySelected = currentQuestion.answers.find(a => a.id === answerId)?.isSelected;
        ...
        currentQuestion.isAnswered = currentQuestion.answers.some(answer => answer.isSelected);
