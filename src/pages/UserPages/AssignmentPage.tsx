...
export function AssignmentPage() {
  ...
  let [selectedAssignmentId, setSelectedAssignmentId] = useState<string | null>(null);
    ...
    const assignments: AssignmentBrief[] = [
        {
            ...
            files: [
                { id: "f1", name: "solution.ts", path: "/files/solution.ts", type: "solution", uploadDate: new Date("2024-05-10") },
            ]
        },
        {
            id: "a2",
        ...
        },
        {
            ...
            files: [
                { id: "f2", name: "schema.sql", path: "/files/schema.sql", type: "solution" },
                { id: "f3", name: "assignment.pdf", path: "/files/assignment.pdf", type: "content" }
            ]
        },
        {
            id: "a4",
        ...
        },
        {
            ...
            date: new Date('2022-05-10'),
            files: [
                { id: "f4", name: "grid.html", path: "/files/grid.html", type: "solution" }
            ]
        },
        {
            id: "a6",
        ...
        },
        {
            ...
            date: new Date('2022-05-10'),
            files: [
                { id: "f5", name: "repo.zip", path: "/files/repo.zip", type: "solution" }
            ]
        },
        {
            id: "a8",
        ...
        },
        {
            ...
            date: new Date('2023-05-10'),
            files: [
                { id: "f6", name: "flow.json", path: "/files/flow.json", type: "solution" }
            ]
        },
        {
            id: "a10",
      ...
      <Content>
        ...
        <div className="flex flex-row gap-8 p-4">
          ...
          <div className="w-3/4 space-y-8">
              <AssignmentTitle assignment={assignments.find(a => a.id === selectedAssignmentId) || assignments[0]} />
              <AssignmentAttachedFiles assignment={assignments.find(a => a.id === selectedAssignmentId) || assignments[0]} />
              <AssignmentSolution assignment={assignments.find(a => a.id === selectedAssignmentId) || assignments[0]} />
              <AssignmentGrade assignment={assignments.find(a => a.id === selectedAssignmentId) || assignments[0]} />
          </div>
        </div>
      </Content>
    </div>
