        ...
        <div className="bg-white h-screen">
            ...
            <Content>
                <CourseFilter
                    ...
                    addAssignmentButton={user?.activeRole === "teacher" && pageMode === "view"}
                />
                <div className="flex flex-row gap-8 p-4">
                    ...
                    <div className="w-1/4 sticky top-0 self-start h-fit space-y-2">
                        {assignments.length === 0 ? (
                            <div
                                className="gap-2 p-4 bg-slate-100 rounded-lg shadow-md hover:bg-slate-200 transition-all text-base">
